...
export const TwitterIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231L18.244 2.25zM16.338 19.19h1.62L6.945 4.303H5.216l11.122 14.887z"/>
    </svg>
);
...
export const WandSparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="m5 3-3 3 3 3 3-3-3-3Z"/><path d="m19 13-3 3 3 3 3-3-3-3Z"/><path d="m22 6-3-3-3 3-3-3-3 3 3 3 3-3 3 3Z"/><path d="m3 18 3 3-3 3-3-3 3-3Z"/><path d="M12 9.5 9.5 12l-5-5L7 4.5Z"/><path d="m14.5 12 5 5L22 14.5l-5-5Z"/></svg>
);
...
export const RocketIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.1S5.34 16.2 4.5 16.5Z"/><path d="m12 8.5-3 3 3 3 3-3-3-3Z"/><path d="M22 2 11 13"/><path d="M17.5 17.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.1S18.34 17.2 17.5 17.5Z"/></svg>
);
...
export const OpenAIIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M22.2819 9.8211a5.9847 5.9847 0 0 0-.5157-4.9108 6.0462 6.0462 0 0 0-6.5098-2.9A6.0651 6.0651 0 0 0 4.9807 4.1818a5.9847 5.9847 0 0 0-3.9977 2.9 6.0462 6.0462 0 0 0 .7427 7.0966 5.98 5.98 0 0 0 .511 4.9107 6.051 6.051 0 0 0 6.5146 2.9001A5.9847 5.9847 0 0 0 13.2599 24a6.0557 6.0557 0 0 0 5.7718-4.2058 5.9894 5.9894 0 0 0 3.9977-2.9001 6.0557 6.0557 0 0 0-.7475-7.0729zm-9.022 12.6081a4.4755 4.4755 0 0 1-2.8764-1.0408l.1419-.0804 4.7783-2.7582a.7948.7948 0 0 0 .3927-.6813v-6.7369l2.02 1.1686a.071.071 0 0 1 .038.052v5.5826a4.504 4.504 0 0 1-4.4945 4.4944zm-9.6607-4.1254a4.4708 4.4708 0 0 1-.5346-3.0137l.142.0852 4.783 2.7582a.7712.7712 0 0 0 .7806 0l5.8428-3.3685v2.3324a.0804.0804 0 0 1-.0332.0615L9.74 19.9502a4.4992 4.4992 0 0 1-6.1408-1.6464zM2.3408 7.8956a4.485 4.485 0 0 1 2.3655-1.9728V11.6a.7664.7664 0 0 0 .3879.6765l5.8144 3.3543-2.0201 1.1685a.0757.0757 0 0 1-.0716 0l-4.8303-2.7865A4.504 4.504 0 0 1 2.3408 7.872zm16.5963 3.8558L13.1038 8.364 15.1192 7.2a.0757.0757 0 0 1 .0716 0l4.8303 2.7913a4.4944 4.4944 0 0 1-.6765 3.3991.23.23 0 0 0-.0445.1056v-7.415a.105.105 0 0 1 .0598-.1045zm-10.9413 4.5683L11.67 14.6633a.0757.0757 0 0 1 .0716 0l5.8144-3.3543v-2.3324a.56.56 0 0 0-.0135-.06.0854.0854 0 0 0-.04-.0752z"/>
    </svg>
);

export const Auth0Icon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M21.98 7.448L19.62 0H4.347L2.02 7.448c-1.352 4.312.03 9.316 3.16 12.572C7.517 22.572 12.018 24.005 16.507 21.819l2.31-7.449c.38-1.235.311-2.591-.198-3.797a4.88 4.88 0 0 0-1.618-2.125zM7.953 8.6c-.095-3.033 1.49-6.08 4.664-6.263 3.146-.182 5.232 2.868 4.807 5.956-.41 3.001-2.56 5.919-5.703 5.566-3.143-.353-5.192-3.005-4.35-5.907z"/>
    </svg>
);
