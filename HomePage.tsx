            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-24 pb-16 overflow-hidden">
                ...
                <div className="relative z-20">
                    <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold tracking-tighter text-white animate-fade-in-up">
                        A Powerful Agent to Build Secure Apps
                    </h1>
                    <p className="mt-8 max-w-4xl mx-auto text-xl md:text-2xl text-zinc-200 text-center leading-relaxed animate-fade-in-up font-code" style={{ animationDelay: '0.2s' }}>
                        Experience the power of our intelligent agent that turns your ideas into production-ready web applications with unprecedented speed and{' '}
                        <span className="relative inline-block">
                            <span className="bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 text-transparent bg-clip-text">
                                beautiful design
                            </span>
                            <svg className="absolute -bottom-1 left-0 w-full h-3 text-pink-400 opacity-70" viewBox="0 0 100 10" preserveAspectRatio="none">
                                <path d="M0,5 C20,10 80,0 100,5" stroke="currentColor" strokeWidth="2" fill="none" />
                            </svg>
                        </span>.
                    </p>
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden border-t-8 border-black animated-cubes-bg">
                ...
                <div className="relative z-10 max-w-4xl mx-auto">
                    ...
                    <p className="mt-8 font-code text-lg md:text-xl text-white/90 leading-relaxed max-w-3xl mx-auto scroll-animate" style={{ transitionDelay: '100ms' }}>
                        Raone is your intelligent agent for app development—a powerful AI that understands your vision and builds complete, production-ready web applications instantly. From concept to deployment in hours, not weeks. Say what you need, and watch as Raone transforms it into code with professional design and enterprise-grade security.
                    </p>
                </div>
            </section>
            ...
            <div className="relative max-w-7xl mx-auto px-6 py-16">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div className="md:col-span-4">
                        ...
                        <p className="mt-4 text-zinc-400 text-sm max-w-xs">The intelligent agent that builds production-ready web applications.</p>
